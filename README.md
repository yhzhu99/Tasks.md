...
tag (e.g. `v5.0.2`) and GitHub Actions builds multi-arch images
(`linux/amd64`, `linux/arm64`) and pushes `5.0.2`, `5.0`, `5`
...
DOCKER_BUILDKIT=1 docker build -t yhzhu99/tasks.md:5.0.2 -t yhzhu99/tasks.md:latest .
docker push yhzhu99/tasks.md:5.0.2
